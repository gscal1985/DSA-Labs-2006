...
class DList {
	...
	// Node constructor for a doubly-linked list
	struct Node {
...
public:
	...
	public:
		...
		// Data members
		Node* mCurr;		// The node the iterator is currently pointing to
		...
		*/
		...
		// Check inequality on two iterators
		// In:	_iter		The iter to compare against the invoking object
		//
...
public:
	...
	// In:	_list			The object to assign from
	//
